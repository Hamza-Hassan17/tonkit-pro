...
return [
    ...
    'list' => [
        ...
        [
            ...
            'price' => 2900,
            'sku'   => 'FF-110M',
            'description' => 'The Flexfit 110 in a mesh-back build — a structured, mid-profile trucker with an adjustable snapback and Flexfit\'s Permacurv® visor. Comfortable one-size fit with a clean front panel for embellishment.',
            'specs' => [
            ...
            'colors' => [
                ...
                ['name' => 'Charcoal', 'slug' => 'charcoal', 'hex' => '#48484a', 'image' => $img('flexfit-110-mesh-cap', 'charcoal.webp')],
                ['name' => 'White',    'slug' => 'white',    'hex' => '#f1f1f1', 'image' => $img('flexfit-110-mesh-cap', 'white.webp')],
                ['name' => 'Black',    'slug' => 'black',    'hex' => '#1a1a1a', 'image' => $img('flexfit-110-mesh-cap', 'black.webp')],
                ['name' => 'Navy',     'slug' => 'navy',     'hex' => '#1c2a3f', 'image' => $img('flexfit-110-mesh-cap', 'navy.webp')],
                ['name' => 'Red',      'slug' => 'red',      'hex' => '#b5202c', 'image' => $img('flexfit-110-mesh-cap', 'red.webp')],
            ],
        ],
