...
<section class="bg-white border-t border-gray-100">
    <div class="container-site grid grid-cols-2 md:grid-cols-4 gap-6 py-10 text-sm">
        @foreach ([
            ...
            ['t' => 'Email', 'd' => 'sales@capbeast.com', 'p' => 'M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75'],
...
<footer class="bg-brand-dark text-gray-400">
    ...
    <div class="bg-brand-orange text-brand-dark/80 text-xs font-medium">
        <div class="container-site flex flex-col sm:flex-row items-center justify-between gap-2 py-4">
            <span>&copy; {{ date('Y') }} CapBeast. All rights reserved.</span>
            <span>Custom caps for teams &amp; businesses.</span>
        </div>
    </div>
</footer>
