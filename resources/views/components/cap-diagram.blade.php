...
<svg viewBox="0 0 200 200" class="w-full h-full" style="{{ $mirror ? 'transform: scaleX(-1)' : '' }}">
    ...
    @elseif ($view === 'back')
        ...
        <path d="M32 100 Q32 40 100 40 Q168 40 168 100 L168 112 Q100 128 32 112 Z"
              fill="#e5e5e0" stroke="#9a9a9c" stroke-width="2"/>
        {{-- Panel seams --}}
        <path d="M64 44 Q58 78 62 114" fill="none" stroke="#c9c9c2" stroke-width="1.5"/>
        <path d="M136 44 Q142 78 138 114" fill="none" stroke="#c9c9c2" stroke-width="1.5"/>
        {{-- Closure strap --}}
        <rect x="78" y="82" width="44" height="16" rx="3" fill="#cfcfc8" stroke="#9a9a9c" stroke-width="1.5"/>
        <circle cx="90" cy="90" r="2" fill="#9a9a9c"/>
        <circle cx="110" cy="90" r="2" fill="#9a9a9c"/>
    @else
        {{-- Side profile --}}
